            ...
            <div class="com-md-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center"><b>Edit Product - {{$product->product_title}}</b></h2>
                    </div>
                <div class="card-body">
                @if (session('success'))
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control  @error('product_image') is-invalid @enderror" id="image" name="product_image"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="product_description" id="product_description" cols="30" rows="10" class="form-control  @error('product_description') is-invalid @enderror">{{ $product->product_description}}"</textarea>
