...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    ...
    <div class="content">
      <h1>Khatri Traders</h1>
      <h2>Quality and Premium Goods</h2>
      <p>Khatri Traders serves you quality goods and services to our customer</p>
    </div>
      <img src="{{asset('site/image/elect.png')}}" alt="...">
    </div>
  </div>
...
<div class="medium">
    ...
    <div class="medium-content col-5">
        ...
        <p>We are Khatri Trades. We deliver original electronic items. Browse a product, add to cart, fill your address, and proceed with your order. We will deliver it safely. We provide you the best quality  items in best price. All the electronic items are brought here direct from the trustworthy traders.We reduce the middleman cost, which makes the price higher</p>
    </div>
</div>
</div>
...
<div class="category">
 ...
 <div class="box-category">
  <div class="box">
    <img src="site/image/watch.png" alt=""><br>
    <b>Watch</b>
  </div>
  <div class="box">
    <img src="site/image/watch.png" alt=""><br>
          ...
          <div class="top-sale-all-product">
              ...
              <div class="content">
                  <div class="product-top">
                     <h2>Good Quality <span class="rate">4.9<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
                  </div>
            ...
            <div class="product">
              ...
              <div class="content">
                  <div class="product-top">
                     <h2>Good Quality <span class="rate">4.8<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
                  </div>
            ...
            <div class="product">
              ...
              <div class="content">
                  <div class="product-top">
                     <h2>Good Quality <span class="rate">4.6<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
                  </div>
            ...
            <div class="product">
              ...
              <div class="content">
                  <div class="product-top">
                     <h2>Good Quality<span class="rate">4.5<span class="star"><i class="fa-solid fa-star"></i></span></span></h2>
                  </div>
